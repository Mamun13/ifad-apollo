						...
						<div className="col-lg-6">
							<ul className="list-group font-calibri text-uppercase list-group-horizontal list-unstyled wrap mt-5 mb-5">
								<li className="pt-2 footer-border">
									<Link to="" className="pe-4 fs-18 text-light ">
										{' '}
										About Us
									</Link>
								</li>
								...
								<li className="pt-2 footer-border">
									<Link to="" className=" fs-18 text-light ">
										{' '}
										News & Events
									</Link>
								</li>
						...
						<div className="d-flex justify-content-between">
							<div className="left">
								<p className="text-light">
									@all rights reserved: Design by <img src={FooterApi} alt="" className="footer-logo" />
								</p>
							</div>
							<div className="right">
								<p className="text-light">
									Terms of use <span className="fs-18"> Privacy Policy</span>
								</p>
							</div>
						</div>
					</div>
